...
export default class SinglePestsWeedsControl extends React.Component {
    componentDidMount() {
                                ...
                                <div className="sidebar">
                                    ...
                                    <div className="sidebar__single sidebar__category wow animated fadeInUp" data-wow-delay="0.2s">
                                        ...
                                        <ul className="sidebar__category-list">
                                            ...
                                            <li className="active"><Link to={process.env.PUBLIC_URL + `/`}>Pests & Weeds Control <span>(14)</span></Link></li>
                                            <li><Link to={process.env.PUBLIC_URL + `/flowers-garden`}>Fruits & Flowers Garden <span>(05)</span></Link></li>
                                        </ul>
                                    </div>
                                    {/* End Sidebar Single */}
