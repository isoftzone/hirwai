...
export default class SingleNurseryTreeFarm extends React.Component {
    componentDidMount() {
                                ...
                                <div className="sidebar">
                                    ...
                                    <div className="sidebar__single sidebar__category wow animated fadeInUp" data-wow-delay="0.2s">
                                        ...
                                        <ul className="sidebar__category-list">
                                            ...
                                            <li className="active"><Link to={process.env.PUBLIC_URL + `/`}>Nursery/Tree Farm <span>(08)</span></Link></li>
